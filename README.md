...
# Running Beehive
# docker run -d -p 8181:8181 -v ./beehivey/beehive.conf:/conf/beehive.conf gabrielalacchi/beehive
docker run -itd -p 8181:8181 -v ./beehivey/beehive.conf:/conf/beehive.conf gabrielalacchi/beehive
```
